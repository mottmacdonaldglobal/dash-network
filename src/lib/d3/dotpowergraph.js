...
(function (dotpowergraph) {
    ...
    function createPowerGraph(inputjson) {
        ...
        //     eventStart[d.subject.routerNode.id] = getEventPos(d.sourceEvent);
        // }
        // function getDragPos(d) {
        //     let p = getEventPos(d.sourceEvent), startPos = eventStart[d.subject.routerNode.id];
        ...
        //     delete eventStart[d.subject.routerNode.id];
        //     console.log(d)
    ...
    d3.text("graphdata/n26e35.dot").then(function (f) {
